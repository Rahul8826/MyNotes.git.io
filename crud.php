<?php
//INSERT INTO `note` (`sno`, `title`, `description`, `tstamp`) VALUES ('1', 'i will code daily', 'practicing PHP daily for more knowledge and for my career', current_timestamp());//
$insert= false;
$update = false;
$delete = false;
 ...
 //Sql query to be executed    
     ...
     if($result){
        ...
        $insert = true;
         ...
         echo "The record has been not inserted successfully because of this error ---->" . mysqli_error($con);
     }
    }
    }
?>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <image class="logo me-auto" style="padding:4px; max-height: 58px; max-width: fit-content;" src="download.png">
...
?>
  <div class="container my-3">
    ...
    <form Action="crud.php" method="post">
      ...
      <div class="form-group">
        <label for="desc">Note Description</label>
        <textarea class="form-control" id="desccription" name="description" rows="3"></textarea>
      </div>
